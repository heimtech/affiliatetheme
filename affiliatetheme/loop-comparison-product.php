...
foreach ($comparisonAttributeList as $key => $comparisonAttribute) {
    ...
    foreach ($comparisonProducts as $comparisonProduct) {
        ...
        if ($i == 0) {
            ...
            $tableHeader .= '<td ' . $highlightedColumnStyle . ' class="compare-product-title compare-product-title-'.$compareTableId.'" id="col-' . $comparisonProduct->ID . '-'.$compareTableId.'">' . $productTitle . '</td>';
