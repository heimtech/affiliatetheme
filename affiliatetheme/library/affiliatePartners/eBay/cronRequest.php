...
if ($_GET['secret'] != md5(trim($eBayAppId))) {
...
$posttype = 'produkt';
$customfieldPid = 'eBay_product_id';
...
if ($postedProducts) {
    ...
    foreach ($postedProducts as $postedProduct) {
        ...
        if ($productId) {
            ...
            // produkt von eBay abholen
            if ($product = $affiliatePartner->getApSingleProduct($productId, 'eBay')) {
                ...
                echo '
                        <tr class="error">
			                ...
			                <td colspan="3">
			                     FEHLER: Request failed. eBay-Server überlastet oder Produkt kann nicht ermittelt werden.
			                     Wenn dieses Problem weiterhin besteht,
			                     wenden Sie sich bitte an den Support von eBay.
			                </td>
			            </tr>';
            }
        } else {
