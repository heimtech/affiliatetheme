...
<h1>Affilinet-Schnittstelle » Preise für bereits erstellte Produkte direkt von Affilinet erhalten</h1>
...
<p>
	...
	gelangen. <br /> 
	<a
		href="http://affiliseo.de/dokumentation/affilinet-preise-importieren/"
...
<div class="alert alert-info">
	...
	<a
		href="<?php echo site_url(); ?>/wp-content/themes/affiliatetheme/library/affiliatePartners/affilinet/cronRequest.php?secret=<?php echo md5(trim(get_option('affilinet_publisher_id'))); ?>"
		target="_blank">
		<strong>
			<?php echo site_url(); ?>/wp-content/themes/affiliatetheme/library/affiliatePartners/affilinet/cronRequest.php?secret=<?php echo md5(trim(get_option('affilinet_publisher_id'))); ?>
		</strong>
	</a>
</div>
...
<h2>Affilinet-Schnittstelle manuell ausf&uuml;hren</h2>
...
jQuery(document).ready(function ($) {
	...
	jQuery("#start_request").click(function () {
		...
		var secretKey = "<?php echo md5(esc_attr(get_option('affilinet_publisher_id'))); ?>";
		...
		jQuery.ajax({
			...
			dataType: "html",
			url: blogurl + '/wp-content/themes/affiliatetheme/library/affiliatePartners/affilinet/cronRequest.php',
