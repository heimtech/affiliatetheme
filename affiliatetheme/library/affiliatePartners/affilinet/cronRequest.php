...
if ($_GET['secret'] != md5(trim(get_option('affilinet_publisher_id')))) {
...
$posttype = 'produkt';
$customfieldPid = 'affilinet_product_id';
...
if ($postedProducts) {
    ...
    foreach ($postedProducts as $postedProduct) {
        ...
        if ($productId) {
            ...
            // produkt von affilinet abholen
            if ($product = $affiliatePartner->getApSingleProduct($productId, 'affilinet')) {
                ...
                echo '
                        <tr class="error">
			                ...
			                <td colspan="3">
			                     FEHLER: Request failed. Affilinet-Server überlastet oder Produkt kann nicht ermittelt werden.
			                     Wenn dieses Problem weiterhin besteht,
			                     wenden Sie sich bitte an den Support von Affilinet.
			                </td>
			            </tr>';
            }
        } else {
