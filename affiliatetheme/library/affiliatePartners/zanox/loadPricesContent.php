...
<h1>Zanox-Schnittstelle » Preise für bereits erstellte Produkte direkt von Zanox erhalten</h1>
...
<p>
	...
	gelangen. <br /> 
	<a
		href="http://affiliseo.de/dokumentation/zanox-preise-importieren/"
...
<div class="alert alert-info">
	...
	<a
		href="<?php echo site_url(); ?>/wp-content/themes/affiliatetheme/library/affiliatePartners/zanox/cronRequest.php?secret=<?php echo md5(trim(get_option('zanox_connect_id'))); ?>"
		target="_blank">
		<strong>
			<?php echo site_url(); ?>/wp-content/themes/affiliatetheme/library/affiliatePartners/zanox/cronRequest.php?secret=<?php echo md5(trim(get_option('zanox_connect_id'))); ?>
		</strong>
	</a>
...
<h2>Zanox-Schnittstelle manuell ausf&uuml;hren</h2>
...
<div style="display: none;" id="public_key"><?php echo md5(esc_attr(get_option('zanox_connect_id'))); ?></div>
...
jQuery(document).ready(function ($) {
	...
	$("#start_request").click(function () {
		...
		$.ajax({
			...
			dataType: "html",
			url: blogurl + '/wp-content/themes/affiliatetheme/library/affiliatePartners/zanox/cronRequest.php',
