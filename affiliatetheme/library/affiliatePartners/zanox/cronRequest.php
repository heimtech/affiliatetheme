...
if ($_GET['secret'] != md5(trim(get_option('zanox_connect_id')))) {
...
$posttype = 'produkt';
$customfieldPid = 'zanox_product_id';
...
if ($postedProducts) {
    ...
    foreach ($postedProducts as $postedProduct) {
        ...
        if ($productId) {
            ...
            // produkt von zanox abholen
            if ($product = $affiliatePartner->getApSingleProduct($productId, 'zanox')) {
                ...
                echo '
                        <tr class="error">
			                ...
			                <td colspan="3">
			                     FEHLER: Request failed. Zanox-Server überlastet oder Produkt kann nicht ermittelt werden.
			                     Wenn dieses Problem weiterhin besteht,
			                     wenden Sie sich bitte an den Support von Zanox.
			                </td>
			            </tr>';
            }
        } else {
