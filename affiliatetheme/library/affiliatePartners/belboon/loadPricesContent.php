...
<h1>Belboon-Schnittstelle » Preise für bereits erstellte Produkte direkt von Belboon erhalten</h1>
...
<p>
	...
	gelangen. <br /> 
	<a
		href="http://affiliseo.de/dokumentation/belboon-preise-importieren/"
...
<div class="alert alert-info">
	...
	<a
		href="<?php echo site_url(); ?>/wp-content/themes/affiliatetheme/library/affiliatePartners/belboon/cronRequest.php?secret=<?php echo md5(trim(get_option('belboon_username'))); ?>"
		target="_blank">
		<strong>
			<?php echo site_url(); ?>/wp-content/themes/affiliatetheme/library/affiliatePartners/belboon/cronRequest.php?secret=<?php echo md5(trim(get_option('belboon_username'))); ?>
		</strong>
	</a>
</div>
...
<h2>Belboon-Schnittstelle manuell ausf&uuml;hren</h2>
...
jQuery(document).ready(function ($) {
	...
	jQuery("#start_request").click(function () {
		...
		var secretKey = "<?php echo md5(esc_attr(get_option('belboon_username'))); ?>";
		...
		jQuery.ajax({
			...
			dataType: "html",
			url: blogurl + '/wp-content/themes/affiliatetheme/library/affiliatePartners/belboon/cronRequest.php',
